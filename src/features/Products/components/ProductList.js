      ...
      <div>
        <div className="bg-white">
          <div>
            ...
            <MobileFilters products={products} handleFilter={handleFilter} sortHandler={sortHandler}
            setMobileFiltersOpen={setMobileFiltersOpen} mobileFiltersOpen={mobileFiltersOpen}/>
{/*DESKTOP FILTERS */}
            <DesktopFilters products={products} handleFilter={handleFilter} sortHandler={sortHandler} setMobileFiltersOpen={setMobileFiltersOpen} mobileFiltersOpen={mobileFiltersOpen}/>
          </div>
        </div>
        {/* pagination */}
...
const MobileFilters=({handleFilter,sortHandler,products,mobileFiltersOpen,setMobileFiltersOpen})=>{
...
const DesktopFilters=({setMobileFiltersOpen,products,handleFilter,sortHandler})=>{
  return(
    <div>
