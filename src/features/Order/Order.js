...
{!params.id&&<Navigate to='/'></Navigate>}
 <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      {orderStatus&&<h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">#{id} Items Placed </h1>}
        {orderStatus&&<p className="mt-6 text-base leading-7 text-gray-600">{orderStatus}</p>}
